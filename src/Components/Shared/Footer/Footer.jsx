...
import bgImg from "../../../../public/images/footer.jpg";

const Footer = () => {
  return (
    <div
      className=" sm: ms-2 sm: me-2 lg:ms-0 lg:me-0 pt-24"
      style={{
    ...
    >
      <div >
            ...
            <div className="last-boxes grid md:grid-cols-2 sm:grid-cols-1 lg:grid-cols-4 gap-5">
              ...
              <div className="">
                <div className="text-center">
                  ...
                  <hr className="mb-3" style={{ borderColor: "white" }} />
                  <div
                    style={{
                      fontFamily: "Montserrat, sans-serif ",
                      fontWeight: 500,
              ...
              <div className="text-center">
                ...
                >
                  <ul>
                    ...
                    <li>
                      <a className="hover:text-black" href="/aboutUs">
                        About us
                      </a>
                    </li>
                    <li>
                      <a className="hover:text-black" href="/platterService">
                        Services
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a className="hover:text-black" href="/contactUs">
                        Contact Us
                      </a>
                    </li>
                    ...
                    <ul className="text-center">
                      <li>
                        <a href="#" className="flex">
                          ...
                          <span className=" ms-3 hover:text-black">
                            {" "}
                            facebook
                          </span>
                        </a>
        ...
        <footer className="copyright">
          <div className=" py-3 mt-16  flex justify-center text-white bg-black">
            <h1
              style={{ fontFamily: "Montserrat, sans-serif ", fontWeight: 500 }}
            >
              copyright @ 2023. All rights reserved by{" "}
              <a target="blank" href="https://marketien.online/">
                MarketienIT
              </a>
            </h1>
          </div>
