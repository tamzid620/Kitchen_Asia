    ...
    return (
      ...
      >
            ...
            data-aos-easing="linear"
             data-aos-duration="500">
                <div className='bg-white  grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 
                 rounded-xl border-t-2 border-[#bc161c] shadow-lg shadow-[#bc161c] p-3 '>
                    ...
                    {/* info section  */}
                    <div className=' p-3'>
                        <h1 className='text-[#bc161c] font-semibold text-2xl mb-3'>Elevate Your Event with Our Culinary Delights and <br /> Impeccable Catering Service.</h1>
                        ...
                        <button  title="Cattering service" className="
                         border-2 border-[#bc161c] bg-transparent text-[#bc161c]
